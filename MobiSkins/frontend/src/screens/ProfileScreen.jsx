...
const ProfileScreen = () => {
  ...
  return (
    <Row>
      <Meta title={`MobiSkins | ${userInfo.name}`} />
      <Col md={3}>
        <h2>Profile</h2>
            ...
            <Form.Control
              ...
              onChange={(e) => {
                e.target.value.length > 10
                  ? toast.warn("Mobile number should be 10 characters")
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  e.target.value.length > 25
                    ? toast.info(
                        "Password should not be more than 25 characters"
                      )
                ...
                <tr key={order._id}>
                  ...
                  <td>
                    <LinkContainer to={`/order/${order._id}`}>
                      <Button variant="dark" className="btn btn-dark btn-sm">
                        Details
                      </Button>
                    </LinkContainer>
                  </td>
